                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:partyTypeInstance, field:'cd')}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:partyTypeInstance, field:'dsc')}</td>
            ...
            <div class="buttons">
                <g:form>
                    ...
                    <div id="theEdit" style="float:left;padding:.8em .8em .8em .8em;font-size:14px;">
                             <g:remoteLink action="edit" id="${partyTypeInstance.id}" update="edit">Edit</g:remoteLink>
                         </div>
                      </span>
