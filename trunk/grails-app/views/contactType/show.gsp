...
<%@ page import="com.grailsPortal.domain.ContactType" %>
        <div class="body">
                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:contactTypeInstance, field:'id')}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:contactTypeInstance, field:'cd')}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:contactTypeInstance, field:'dsc')}</td>
            ...
            <div class="buttons">
                <g:form>
                    <input type="hidden" name="id" value="${contactTypeInstance?.id}" />
                    <div id="theEdit" style="float:left;padding:.8em .8em .8em .8em;font-size:14px;">
                             <g:remoteLink action="edit" id="${contactTypeInstance.id}" update="edit">Edit</g:remoteLink>
                         </div>
                      </span>
