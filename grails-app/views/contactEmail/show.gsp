                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:contactEmailInstance, field:'id')}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:contactEmailInstance, field:'emailAddress')}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name">Verified:</td>
                            
                            <td valign="top" class="value">${fieldValue(bean:contactEmailInstance, field:'verified')}</td>
            ...
            <div class="buttons">
                <g:form>
                    ...
                    <div id="theEdit" style="float:left;padding:.8em .8em .8em .8em;font-size:14px;">
                             <g:remoteLink action="edit" id="${contactEmailInstance.id}" update="edit">Edit</g:remoteLink>
                         </div>
                      </span>
