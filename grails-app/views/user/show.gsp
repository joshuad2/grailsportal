...
<html>
    <head>
        ...
        <title>Show West Orlando Arts Foundation User Profile</title>
    </head>
    <body>
        <div class="nav">
            <span class="menuButton"><a class="home" href="${resource(dir:'')}">Home</a></span>
            <span class="menuButton"><g:link class="list" action="list">User Profiles</g:link></span>
            <span class="menuButton"><g:link class="create" action="create">New User Profile</g:link></span>
        </div>
        <div class="body">
            <h1>Show West Orlando Arts Foundation User Profile</h1>
                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="party" action="show" id="${jsecUserInstance?.party?.id}">${jsecUserInstance?.party?.encodeAsHTML()}</g:link></td>
