...
<div class="body">
<h1>Edit PortalMenuConfiguration</h1>
...
>
  ...
  <input type="hidden" name="version" value="${portalMenuConfigurationInstance?.version}" />
  <div class="dialog">
    <table>
	  <tbody>
	  
			    <tr class="prop">
			      <td valign="top" class="name"><label for="menuName"> Menu Name:</label></td>
			      <td valign="top"
					class="value ${hasErrors(bean:portalMenuConfigurationInstance,field:'menuName','errors')}">
			    ...
			    <tr class="prop">
			      <td valign="top" class="name"><label for="position"> Position:</label></td>
			      <td valign="top"
					class="value ${hasErrors(bean:portalMenuConfigurationInstance,field:'position','errors')}">
			    ...
			    <tr class="prop">
			      <td valign="top" class="name"><label for="hideDelay"> Hide Delay:</label></td>
			      <td valign="top"
					class="value ${hasErrors(bean:portalMenuConfigurationInstance,field:'hideDelay','errors')}">
			    ...
			    <tr class="prop">
			      <td valign="top" class="name"><label for="lazyLoad"> Lazy Load:</label></td>
			      <td valign="top"
					class="value ${hasErrors(bean:portalMenuConfigurationInstance,field:'lazyLoad','errors')}">
			    ...
			    <tr class="prop">
			      <td valign="top" class="name"><label for="style"> Style:</label></td>
			      <td valign="top"
					class="value ${hasErrors(bean:portalMenuConfigurationInstance,field:'style','errors')}">
			      <input type="text" maxlength="200" id="style" name="style" value="${fieldValue(bean:portalMenuConfigurationInstance,field:'style')}"/>
			      </td>
			    </tr>
			
			    <tr class="prop">
			      <td valign="top" class="name"><label for="width"> Width:</label></td>
			      <td valign="top"
					class="value ${hasErrors(bean:portalMenuConfigurationInstance,field:'width','errors')}">
			      <input type="text" maxlength="30" id="width" name="width" value="${fieldValue(bean:portalMenuConfigurationInstance,field:'width')}"/>
			      </td>
			    </tr>
			
			    <tr class="prop">
			      <td valign="top" class="name"><label for="height"> Height:</label></td>
			      <td valign="top"
					class="value ${hasErrors(bean:portalMenuConfigurationInstance,field:'height','errors')}">
			      <input type="text" maxlength="30" id="height" name="height" value="${fieldValue(bean:portalMenuConfigurationInstance,field:'height')}"/>
			      </td>
			    </tr>
			
			    <tr class="prop">
			      <td valign="top" class="name"><label for="borderStyle"> Border Style:</label></td>
			      <td valign="top"
					class="value ${hasErrors(bean:portalMenuConfigurationInstance,field:'borderStyle','errors')}">
			      <textarea rows="5" cols="40" name="borderStyle">${fieldValue(bean:portalMenuConfigurationInstance, field:'borderStyle')}</textarea>
			      </td>
			    </tr>
			
			    <tr class="prop">
			      <td valign="top" class="name"><label for="borderWidth"> Border Width:</label></td>
			      <td valign="top"
					class="value ${hasErrors(bean:portalMenuConfigurationInstance,field:'borderWidth','errors')}">
			    ...
			    <tr class="prop">
			      <td valign="top" class="name"><label for="borderHeight"> Border Height:</label></td>
			      <td valign="top"
					class="value ${hasErrors(bean:portalMenuConfigurationInstance,field:'borderHeight','errors')}">
			    ...
			    <tr class="prop">
			      <td valign="top" class="name"><label for="margin"> Margin:</label></td>
			      <td valign="top"
					class="value ${hasErrors(bean:portalMenuConfigurationInstance,field:'margin','errors')}">
			      <input type="text" maxlength="30" id="margin" name="margin" value="${fieldValue(bean:portalMenuConfigurationInstance,field:'margin')}"/>
			      </td>
			    </tr>
			
			    <tr class="prop">
			      <td valign="top" class="name"><label for="isActive"> Is Active:</label></td>
			      <td valign="top"
					class="value ${hasErrors(bean:portalMenuConfigurationInstance,field:'isActive','errors')}">
			    ...
			    <tr class="prop">
			      <td valign="top" class="name"><label for="portalConfig"> Portal Config:</label></td>
			      <td valign="top"
					class="value ${hasErrors(bean:portalMenuConfigurationInstance,field:'portalConfig','errors')}">
...
<g:remoteLink controller="portalConfig" id="" action="create" update="createPortalConfig">Add</g:remoteLink>
           ...
           <gui:dialog title="Add a PortalConfig" modal="true" form="false" triggers="[show:[id:'createThePortalConfig', on:'click']]" fixedCenter="true"]>
             <div class="dialog" id="createPortalConfig" style="width:600px;height:400px;overflow:scroll"></div>
			    ...
			    <tr class="prop">
			      <td valign="top" class="name"><label for="portalMenus"> Portal Menus:</label></td>
			      <td valign="top"
					class="value ${hasErrors(bean:portalMenuConfigurationInstance,field:'portalMenus','errors')}">
			      
<ul>
<g:each var="p" in="${portalMenuConfigurationInstance?.portalMenus?}">
<li><div id="editThePortalMenu"><g:remoteLink update="editPortalMenu" controller="PortalMenu" action="show" id="${p.id}">${p?.encodeAsHTML()}</g:remoteLink></li>
</g:each>
</ul>

<g:link controller="portalMenu" params="['portalMenuConfiguration.id':portalMenuConfigurationInstance?.id]" action="create">Add</g:link>
