...
<div class="nav">
 <span class="menuButton"><a class="home"
	href="${resource(dir:'')}">Home</a>
</span> 
<span class="menuButton" id="createThePortalSubMenu"> 
    <g:link action="create">New</g:link> 
</span>
</div>
<div class="body">
<h1>Edit PortalSubMenu</h1>
...
>
  ...
  <input type="hidden" name="version" value="${portalSubMenuInstance?.version}" />
  <div class="dialog">
    <table>
	  <tbody>
	  
			    <tr class="prop">
			      <td valign="top" class="name"><label for="theController"> The Controller:</label></td>
			      <td valign="top"
					class="value ${hasErrors(bean:portalSubMenuInstance,field:'theController','errors')}">
			    ...
			    <tr class="prop">
			      <td valign="top" class="name"><label for="theAction"> The Action:</label></td>
			      <td valign="top"
					class="value ${hasErrors(bean:portalSubMenuInstance,field:'theAction','errors')}">
			      <input type="text" maxlength="40" id="theAction" name="theAction" value="${fieldValue(bean:portalSubMenuInstance,field:'theAction')}"/>
			      </td>
			    </tr>
			
			    <tr class="prop">
			      <td valign="top" class="name"><label for="text"> Text:</label></td>
			      <td valign="top"
					class="value ${hasErrors(bean:portalSubMenuInstance,field:'text','errors')}">
			      <input type="text" maxlength="100" id="text" name="text" value="${fieldValue(bean:portalSubMenuInstance,field:'text')}"/>
			      </td>
			    </tr>
			
			    <tr class="prop">
			      <td valign="top" class="name"><label for="isAjax"> Is Ajax:</label></td>
			      <td valign="top"
					class="value ${hasErrors(bean:portalSubMenuInstance,field:'isAjax','errors')}">
			    ...
			    <tr class="prop">
			      <td valign="top" class="name"><label for="showSpinner"> Show Spinner:</label></td>
			      <td valign="top"
					class="value ${hasErrors(bean:portalSubMenuInstance,field:'showSpinner','errors')}">
			    ...
			    <tr class="prop">
			      <td valign="top" class="name"><label for="mainMenu"> Main Menu:</label></td>
			      <td valign="top"
					class="value ${hasErrors(bean:portalSubMenuInstance,field:'mainMenu','errors')}">
...
<g:link controller="portalMenu" id="" action="create"">Add</g:link>
			    ...
			    <tr class="prop">
			      <td valign="top" class="name"><label for="showAdmin"> Show Admin:</label></td>
			      <td valign="top"
					class="value ${hasErrors(bean:portalSubMenuInstance,field:'showAdmin','errors')}">
			    ...
			    <tr class="prop">
			      <td valign="top" class="name"><label for="showAnonymous"> Show Anonymous:</label></td>
			      <td valign="top"
					class="value ${hasErrors(bean:portalSubMenuInstance,field:'showAnonymous','errors')}">
			    ...
			    <tr class="prop">
			      <td valign="top" class="name"><label for="portalMenuType"> Portal Menu Type:</label></td>
			      <td valign="top"
					class="value ${hasErrors(bean:portalSubMenuInstance,field:'portalMenuType','errors')}">
